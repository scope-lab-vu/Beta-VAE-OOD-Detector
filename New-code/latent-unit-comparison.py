        ...
        for model in models:
            ...
            for run in runs:
                ...
                if run == "precipitation":
                    ...
                    csv_list = csv_list1
                path = "/home/scope/Carla/CARLA_0.9.6/PythonAPI/TCPS-results/Latent-extraction-new1/" + model + '/'
                ...
                with open(path + run + '-comparison.csv', 'a') as csvfile:
